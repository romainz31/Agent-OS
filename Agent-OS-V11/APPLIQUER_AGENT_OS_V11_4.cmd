...
chcp 65001 >nul
title Agent-OS V11.4 - Semantic Gate
cd /d "%~dp0"
...
echo.
echo ========================================================
echo    AGENT-OS V11.4 - CORRECTIF PAUL / MEMOIRE SEMANTIQUE
echo ========================================================
echo.
...
if not exist "%SRC_EXT%" (
    echo [ERREUR] Le gate V11.4 est absent du ZIP.
    goto ERROR_END
)
if not exist "%A0%" (
...
echo [1/5] Installation du plugin V11.4...
...
findstr /C:"version: 11.4.0" "%PLUGIN%\plugin.yaml" >nul || goto COPY_ERROR
findstr /C:"PAUL_IDENTITY_GUARD_V11_4" "%PLUGIN%\agents\paul\prompts\agent.system.main.specifics.md" >nul || goto COPY_ERROR
echo [OK] Fichiers V11.4 verifies.
...
echo.
echo ========================================================
echo   V11.4 INSTALLEE - verification runtime a faire au lancement
 echo ========================================================
echo.
echo Au prochain demarrage, lance DIAGNOSTIQUER_AGENT_OS_V11_4.cmd
...
echo.
echo ========================================================
echo                 V11.4 INSTALLEE ET VERIFIEE
 echo ========================================================
echo.
...
goto ERROR_END
:COPY_ERROR
echo [ERREUR] Copie ou verification des fichiers V11.4 impossible.
goto ERROR_END
:DOCKER_ERROR
...
echo Lance DIAGNOSTIQUER_AGENT_OS_V11_4.cmd et copie-moi le resultat.
goto ERROR_END
