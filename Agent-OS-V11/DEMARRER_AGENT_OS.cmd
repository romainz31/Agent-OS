...
:CONTAINER_READY
echo [INFO] Verification du plugin Agent-OS V11...
...
if errorlevel 1 (
    ...
    echo [OK] Plugin Agent-OS V11 detecte.
)
...
echo Relance l'installation/configuration Docker de la V11 une premiere fois.
goto ERROR_END
