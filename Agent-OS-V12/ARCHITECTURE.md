# Architecture mémoire V12

## Répartition des responsabilités

V12 ajoute une couche sémantique locale : Qwen propose une extraction ou un
plan de requête, Python valide les valeurs, puis SQLite écrit et restitue les
preuves. Le modèle local n'est jamais la source de vérité.
...
types, dates, états et transitions avant d'écrire quoi que ce soit. La
formulation complète de l'utilisateur reste conservée, les attributs détaillés
ont leur propre historique, et un comptage additionne les occurrences plutôt
