...
- V12 accepte aussi les états sémantiques planned, in_progress, completed et
  cancelled. Une requête aggregate=count additionne les occurrences mémorisées
  au lieu de compter uniquement les lignes SQLite.
