...
Le pipeline sémantique local V12 peut capturer plusieurs informations d'un même
message. Il garde le texte source complet et SQLite reste la source de vérité ;
le modèle local ne doit jamais inventer une mémoire.
