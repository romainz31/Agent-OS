...
class Memory:
    ...
    def personal_profile_value(self, *subjects: str) -> str | None:
        if self.profile_v2 is None:
            return None
        return self.profile_v2.profile_value(*subjects)

    def personal_identity_facts(self, message: str) -> list[dict[str, Any]]:
        if self.profile_v2 is None:
            return []
        return self.profile_v2.explicit_identity_facts(message)
    ...
    def concise_summary(self) -> str:
        ...
        return (
            ...
            + "\nPROFIL DURABLE STRUCTURÉ\n"
            + self.personal_profile_summary()
            + "\n\nAUTRES COUCHES PERSONNELLES\n"
