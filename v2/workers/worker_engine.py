...
- placer les tâches concernées en waiting_approval ;
- reprendre les dépendances après résolution humaine.
"""
...
class WorkerEngine:
    ...
    def resume_dependents(
        ...
        """
        API publique utilisée notamment après
        résolution d'une approbation humaine.
        """
